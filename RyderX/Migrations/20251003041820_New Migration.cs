        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DropoffAt = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CarLicensePlate = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    PickupAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    DropoffAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_BookingHistories_Reservations_ReservationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookingHistories_ReservationId",
